...
// import { getAllUsersUrls } from '../api/user.api'
      ...
      <div className='overflow-x-auto max-h-72'>
        <table className='min-w-full divide-y divide-gray-200'>
          <thead className='bg-gray-100 sticky top-0 z-10'>
            <tr>
              <th className='px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase'>Original URL</th>
              <th className='px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase'>Short URL</th>
              <th className='px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase'>Clicks</th>
                ...
                <td className='px-6 py-4'>
                  <button
                    ...
                    className={`inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md transition ${
                      copiedId === url._id ? 'bg-green-500 text-white hover:bg-green-600' : 'bg-blue-600 text-white hover:bg-blue-700'
